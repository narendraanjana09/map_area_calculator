...
public class StartNavigationActivity extends AppCompatActivity  implements
    ...
    public void onMapReady(MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(StartNavigationActivity.this);
...
// Call this method with Context from within an Activity
    ...
    private void getRoute(Point origin, Point destination) {
        NavigationRoute.builder(StartNavigationActivity.this)
...
// You can get the generic HTTP info about the response
                        Toast.makeText(StartNavigationActivity.this, "Response code: " + response.code(), Toast.LENGTH_SHORT).show();
                        Log.d(TAG, "Response code: " + response.code());
                        if (response.body() == null) {
                            Toast.makeText(StartNavigationActivity.this, "No routes found, make sure you set the ri", Toast.LENGTH_SHORT).show();
                            Log.e(TAG, "No routes found, make sure you set the right user and access token.");
                            return;
                        } else if (response.body().routes().size() < 1) {
                            Toast.makeText(StartNavigationActivity.this, "No routes found", Toast.LENGTH_SHORT).show();
